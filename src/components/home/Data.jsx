  ...
  return (
    <div className="home__data">
      ...
      <p className="home__description">
        Software Engineer with a strong focus on data engineering and
        development. During my internship, i gained valuable experience working
        on data migration, scripting, handling large datasets, and developing
        efficient software solutions. I have contributed to various projects,
        including full-stack applications, and I am skilled in a range of
        technologies such as Java, Python, and React. I'm also expanding my
        expertise in cloud services and DevOps practices, which makes me a
        versatile engineer ready to take on new challenges.
      </p>
